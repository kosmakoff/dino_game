...
impl DinoData {
    pub fn new(
        ...
        normal_state_start: [f32; 2],
        normal_state_size: [f32; 2],
        crouched_state_start: [f32; 2],
        crouched_state_size: [f32; 2],
    ) -> Self {
        ...
        let image_walk1 = Tile::new(
            [
                normal_state_start_x + normal_state_size_width * 2.0,
                normal_state_start_y,
            ],
            normal_state_size,
            sprite_sheet_size,
        ...
        let image_walk2 = Tile::new(
            [
                normal_state_start_x + normal_state_size_width * 3.0,
                normal_state_start_y,
            ],
            normal_state_size,
            sprite_sheet_size,
